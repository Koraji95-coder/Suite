...
type CalculationType = 'ohms-law' | 'power' | 'reactance' | 'resonance' | 'time-constant' | 'impedance';
    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-3">
        <div className="p-3 bg-gradient-to-br from-orange-500/20 to-amber-500/10 rounded-lg">
          <Zap className="w-8 h-8 text-orange-400 animate-pulse" style={{ animationDuration: '1.5s' }} />
        </div>
        <div>
          <h2 className="text-3xl font-bold text-white/90">Electrical Calculations</h2>
          <p className="text-orange-400/70 text-sm">Power, impedance, and circuit analysis</p>
        </div>
      </div>
        ...
        <FrameSection title="Results">
          <div className="space-y-3">
            {results.map((result, index) => (
              <div key={index} className="flex justify-between items-center bg-black/50 rounded-lg px-4 py-3 border border-white/10">
                <span className="text-white/60 font-medium">{result.label}:</span>
          ...
          <div className="mt-6">
            ...
            <textarea
              ...
              className="w-full bg-black/50 border border-orange-500/30 rounded-lg px-4 py-2 text-white/90 focus:outline-none focus:ring-2 focus:ring-orange-500 min-h-[80px]"
          ...
          <button
            ...
            className="mt-4 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white font-semibold px-6 py-3 rounded-lg transition-all shadow-lg shadow-orange-500/30 flex items-center space-x-2"
          >
