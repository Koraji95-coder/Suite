import { Pen, Eraser, Square, Circle, Type, Undo, Redo, Trash2, Save, Download } from 'lucide-react';

interface WhiteboardToolbarProps {
  tool: 'pen' | 'eraser' | 'rectangle' | 'circle' | 'text';
  onToolChange: (tool: 'pen' | 'eraser' | 'rectangle' | 'circle' | 'text') => void;
  color: string;
    ...
    <div className="w-20 bg-black/40 border-r border-white/[0.06] flex flex-col items-center py-4 space-y-2">
      <button
        ...
        className={`p-3 rounded-lg transition-all ${
          tool === 'pen' ? 'bg-orange-500/30 border border-orange-400' : 'hover:bg-orange-500/10'
        }`}
        title="Pen"
      >
      ...
      <button
        ...
        className={`p-3 rounded-lg transition-all ${
          tool === 'eraser' ? 'bg-orange-500/30 border border-orange-400' : 'hover:bg-orange-500/10'
        }`}
        title="Eraser"
      >
      ...
      <button
        ...
        className={`p-3 rounded-lg transition-all ${
          tool === 'rectangle' ? 'bg-orange-500/30 border border-orange-400' : 'hover:bg-orange-500/10'
        }`}
        title="Rectangle"
      >
      ...
      <button
        ...
        className={`p-3 rounded-lg transition-all ${
          tool === 'circle' ? 'bg-orange-500/30 border border-orange-400' : 'hover:bg-orange-500/10'
        }`}
        title="Circle"
      >
      ...
      <button
        ...
        className={`p-3 rounded-lg transition-all ${
          tool === 'text' ? 'bg-orange-500/30 border border-orange-400' : 'hover:bg-orange-500/10'
        }`}
        title="Text"
      >
