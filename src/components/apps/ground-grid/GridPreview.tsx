...
export function GridPreview({
	...
	return (
		...
		>
			...
			>
				<span>
					<b style={{ color: "#22c55e" }}>Rods:</b>{" "}
					{rods.length - testWells.length}
				</span>
				<span>
					<b style={{ color: "#ef4444" }}>Test Wells:</b> {testWells.length}
				</span>
				<span>
					<b style={{ color: "#f59e0b" }}>Segments:</b> {segmentCount}
				</span>
				<span>
					<b style={{ color: "#3b82f6" }}>Tees:</b> {tees.length}
				</span>
				<span>
					<b style={{ color: "#06b6d4" }}>Crosses:</b> {crosses.length}
				</span>
			</div>
