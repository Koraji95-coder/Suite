...
const BLUR: Record<"low" | "medium" | "high", number> = {
	low: 12,
	medium: 22,
	high: 34,
};
const BG_OPACITY: Record<"low" | "medium" | "high", number> = {
	low: 0.1,
	medium: 0.13,
	high: 0.17,
};
	...
	(
		...
		const panelStyle: CSSProperties = {
			...
			background:
              ...
              ${hexToRgba(palette.surface, 0.5)} 48%,
			...
			transform: tilt
				? "perspective(800px) rotateX(var(--gp-rx)) rotateY(var(--gp-ry))"
				: undefined,
