...
export function BlockLibrary() {
	...
	return (
		<div className="space-y-6">
			...
			{loading ? (
				<div className="text-center text-orange-300 py-12">
					Loading blocks...
				</div>
				...
				<div className="space-y-4">
					{Object.entries(blocksByCategory).map(
						([category, categoryBlocks]) => (
							<div
								key={category}
								className="bg-black/30 backdrop-blur-md border border-orange-500/30 rounded-lg overflow-hidden"
							>
								<button
								...
								>
									<div className="flex items-center space-x-3">
										...
										<h3 className="text-lg font-bold text-white/80 capitalize">
											{category}
										</h3>
