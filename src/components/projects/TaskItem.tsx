import { GripVertical, ChevronDown, ChevronRight, CheckSquare, Square, Clock, Plus, Edit, Trash2 } from 'lucide-react';
import { useSortable } from '@dnd-kit/sortable';
import { CSS } from '@dnd-kit/utilities';
import { Task } from './projectmanagertypes';
import { getPriorityColor, getUrgencyColor, formatDateOnly } from './projectmanagerutils';
    ...
    <div ref={setNodeRef} style={style} className="space-y-2">
      ...
      >
        ...
        <div className="flex-1">
          ...
          {task.due_date && (
            <div className={`flex items-center space-x-1 text-xs mt-1 ${getUrgencyColor(task.due_date)}`}>
