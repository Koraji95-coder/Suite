...
describe("DeveloperPortalRoutePage", () => {
	it("renders the grouped developer branch for dev users", () => {
		...
		expect(screen.getByText("Developer pulse")).toBeTruthy();
		expect(screen.getByText("Developer workbenches")).toBeTruthy();
		expect(screen.getByText("Work ledger and evidence")).toBeTruthy();
		...
		expect(screen.getByText("Open Command Center")).toBeTruthy();
	});
