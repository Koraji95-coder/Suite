...
export const COMPONENT_LINES: Record<string, number> = {
	"DashboardOverviewPanel.tsx": 618,
	"DashboardShell.tsx": 838,
	"AppBackground.tsx": 19,
	"PanelInfoDialog.tsx": 141,
	"ToastProvider.tsx": 78,
	"FloatingWhiteboardButton.tsx": 88,
	"VectorCalculator.tsx": 473,
	"SinusoidalCalculator.tsx": 397,
	"MathReference.tsx": 395,
	"SymmetricalComponents.tsx": 387,
	"CalculatorPanel.tsx": 333,
	"ThreePhaseCalculator.tsx": 315,
	"CircuitGenerator.tsx": 256,
	"PlotGenerator.tsx": 219,
	"FormulaBank.tsx": 214,
	"QAQCChecker.tsx": 656,
	"TransmittalBuilder.tsx": 654,
	"BlockLibrary.tsx": 523,
	"AppsHub.tsx": 478,
	"GroundGridGenerator.tsx": 365,
	"AIChat.tsx": 432,
	"Whiteboard.tsx": 433,
	"WhiteboardLibrary.tsx": 238,
...
export const COMP_TO_GROUP: Record<string, string> = {
	"DashboardOverviewPanel.tsx": "dash",
	"DashboardShell.tsx": "dash",
	"AppBackground.tsx": "dash",
	"PanelInfoDialog.tsx": "dash",
	"ToastProvider.tsx": "dash",
	"FloatingWhiteboardButton.tsx": "dash",
	"VectorCalculator.tsx": "know",
	"SinusoidalCalculator.tsx": "know",
	"MathReference.tsx": "know",
	"SymmetricalComponents.tsx": "know",
	"CalculatorPanel.tsx": "know",
	"ThreePhaseCalculator.tsx": "know",
	"CircuitGenerator.tsx": "know",
	"PlotGenerator.tsx": "know",
	"FormulaBank.tsx": "know",
	"QAQCChecker.tsx": "apps",
	"TransmittalBuilder.tsx": "apps",
	"BlockLibrary.tsx": "apps",
	"AppsHub.tsx": "apps",
	"GroundGridGenerator.tsx": "apps",
	"AIChat.tsx": "apps",
	"Whiteboard.tsx": "apps",
	"WhiteboardLibrary.tsx": "apps",
...
export const MINOR_TO_COMPS: Record<string, string[]> = {
	"Activity Feed": ["DashboardOverviewPanel.tsx"],
	"Calendar Integration": ["DashboardOverviewPanel.tsx"],
	...
	Calculations: ["CalculatorPanel.tsx"],
	"Vector Analysis": ["VectorCalculator.tsx"],
	...
	"Math Reference": ["MathReference.tsx"],
	"Plot Diagrams": ["PlotGenerator.tsx"],
	"Circuit Generator": ["CircuitGenerator.tsx"],
	"Formula Bank": ["FormulaBank.tsx"],
	Electronics: ["CalculatorPanel.tsx"],
	"Digital Logic": ["CalculatorPanel.tsx"],
	Electromagnetics: [],
	"QA/QC Checker": ["QAQCChecker.tsx"],
	"Block Library": ["BlockLibrary.tsx"],
...
export const MAJOR_DESC: Record<string, string> = {
	...
	equip:
		"Static: Transformers, transmission lines, reactors, capacitors · Rotating: Sync generators, motors, wind machines · Detailed specs, datasheets & configurations · Equipment-to-calculation integration",
...
export const OVERLAPS: [string, string][] = [
	["QA/QC Checker", "National Electric Code"],
	["QA/QC Checker", "IEEE Standards"],
	["Block Library", "File Management"],
	["Transmittal Builder", "File Management"],
	["Transmittal Builder", "Projects Hub"],
	["Formula Bank", "Calculations"],
	["Three-Phase Systems", "Symmetrical Components"],
	["Circuit Generator", "Electronics"],
	["Calculations", "Transformers"],
	["Three-Phase Systems", "Sync Generators"],
	["Three-Phase Systems", "Motors"],
	["Ground Grid Generator", "IEEE Standards"],
	["Storage Monitor", "File Management"],
	["Calendar Integration", "Calendar Events"],
	["Activity Feed", "Activity Logging"],
	["AI Assistant", "Calculations"],
	["Project Overview", "Task Management"],
	["Plot Diagrams", "Math Reference"],
	["Vector Analysis", "Electromagnetics"],
	["Sinusoidal & Per-Unit", "Three-Phase Systems"],
	["Digital Logic", "Electronics"],
	["Whiteboard", "Projects Hub"],
];
