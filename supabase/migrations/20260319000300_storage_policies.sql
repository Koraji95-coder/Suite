-- Local Supabase migration source of truth for Suite storage policies.
-- Legacy hosted fallback copy remains at backend/supabase/storage_policies.sql.
-- Run after 20260319000200_rls_hardening.sql.
