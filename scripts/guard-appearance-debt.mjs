...
const visualInlineStyleAllowlist = new Set(
	[
		...
		"src/features/ground-grid-generation/ui/GridBackground.tsx",
		"src/features/ground-grid-generation/ui/GridGeneratorDataColumn.tsx",
		"src/features/ground-grid-generation/ui/GridGeneratorDataDropzone.tsx",
		"src/features/ground-grid-generation/ui/GridGeneratorDataPreviewTables.tsx",
		"src/features/ground-grid-generation/ui/GridGeneratorPastePanel.tsx",
		"src/features/ground-grid-generation/ui/GridGeneratorPreviewColumn.tsx",
		"src/features/ground-grid-generation/ui/GridGeneratorTopBar.tsx",
		"src/features/ground-grid-generation/ui/GridManualEditorCanvas.tsx",
		"src/features/ground-grid-generation/ui/GridManualEditorTables.tsx",
		"src/features/ground-grid-generation/ui/GridManualEditorToolbar.tsx",
		"src/features/ground-grid-generation/ui/GridOverlayCard.tsx",
		"src/features/ground-grid-generation/ui/GridPreviewOverlay.tsx",
		"src/features/ground-grid-generation/ui/GridPreviewSvg.tsx",
		"src/features/ground-grid-generation/ui/PotentialContourOverlay.tsx",
		"src/features/coordinates-grabber/ui/CoordinatesGrabberConfigTab.tsx",
		"src/features/coordinates-grabber/ui/CoordinatesGrabberExportTab.tsx",
		"src/features/coordinates-grabber/ui/CoordinatesGrabberLayerSearchPanels.tsx",
		"src/features/coordinates-grabber/ui/CoordinatesGrabberValidationPanel.tsx",
...
const visualInlineStyleAllowlistPrefixes = ["src/features/ground-grid-generation/ui/"].map(
	normalizeRelPath,
);
