...
type BadgeColor = 'default' | 'primary' | 'accent' | 'success' | 'warning' | 'danger' | 'info';
...
const baseClasses = 'inline-flex items-center justify-center gap-1.5 font-medium whitespace-nowrap rounded-full';
...
type Status = 'active' | 'inactive' | 'pending' | 'complete' | 'error' | 'draft';
