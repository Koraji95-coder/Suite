		...
		<div className="space-y-6">
			...
			{showUploadModal && (
				<div className="fixed inset-0 z-50 flex items-center justify-center bg-[color:rgb(10_10_10_/_0.62)] p-4 backdrop-blur-sm">
					<div className="suite-modal-shell-max w-full max-w-md overflow-y-auto rounded-lg border border-[var(--border)] bg-[var(--bg-heavy)] p-6 backdrop-blur-xl">
			...
			{selectedBlock && (
				<div className="fixed inset-0 z-50 flex items-center justify-center bg-[color:rgb(10_10_10_/_0.72)] p-4 backdrop-blur-sm">
					<div className="suite-modal-shell-max w-full max-w-4xl overflow-auto rounded-lg border border-[var(--border)] bg-[var(--bg-heavy)] backdrop-blur-xl">
