...
const sheetVariants = cva(
  cn(
    "fixed z-50 gap-4 bg-surface border-border p-6 shadow-lg transition ease-in-out",
  ...
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 text-text-muted hover:text-text hover:bg-surface-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
          <X className="h-4 w-4" />
