...
import { HardDrive, FileText, Database, Shield } from 'lucide-react';
    ...
    <div style={{ padding: 24 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: palette.text }}>Storage</h2>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: active ? hexToRgba(palette.primary, 0.18) : hexToRgba(palette.surface, 0.4),
                  border: active ? `1px solid ${palette.primary}` : `1px solid ${hexToRgba(palette.textMuted, 0.15)}`,
