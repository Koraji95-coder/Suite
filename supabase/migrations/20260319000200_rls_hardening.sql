-- Local Supabase migration source of truth for Suite row-level security hardening.
-- Legacy hosted fallback copy remains at backend/supabase/rls_hardening.sql.
-- Run after 20260319000100_schema_bootstrap.sql.
