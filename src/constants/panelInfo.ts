	...
	sections: [
		{
			...
			content:
				"The Project Manager allows you to organize your electrical engineering projects with tasks, deadlines, files, and calendar integration. Create hierarchical task structures with subtasks and track project progress.",
		},
		{
	...
	sections: [
		{
			...
			content:
				"The Knowledge Base contains all your electrical engineering tools, formulas, calculations, and reference materials. Add custom content to any section to build your personal engineering library.",
		},
		{
	...
	sections: [
		{
			...
			content:
				"Manage your electrical engineering standards including NEC (National Electric Code), IEEE Standards, IEC, ANSI, NEMA, and custom standards. Upload, organize, and search through all your compliance documents.",
		},
		{
	...
	sections: [
		{
			...
			content:
				"Comprehensive database of electrical equipment specifications, datasheets, and technical information. Organized into Static Equipment (transformers, transmission lines) and Rotating Equipment (generators, motors).",
		},
		{
