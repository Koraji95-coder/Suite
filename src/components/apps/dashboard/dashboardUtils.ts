import { getUrgencyTextColor } from "../calendar/urgencyUtils";
...
export const getUrgencyColor = (deadline: string | null) =>
	getUrgencyTextColor(deadline);
export const getTaskUrgencyColor = (dateStr: string) =>
	getUrgencyTextColor(dateStr);
