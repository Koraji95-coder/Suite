...
export function QAQCChecker() {
	...
	return (
		<div className="space-y-6">
			...
			{showRulesModal && (
				<div className="fixed inset-0 z-50 flex items-center justify-center bg-[color:rgb(10_10_10_/_0.62)] p-4 backdrop-blur-sm">
					<div className="suite-modal-shell-max w-full max-w-3xl overflow-auto rounded-lg border border-green-500/30 bg-[var(--color-surface)] p-6 backdrop-blur-xl">
			...
			{selectedDrawing && (
				<div className="fixed inset-0 z-50 flex items-center justify-center bg-[color:rgb(10_10_10_/_0.72)] p-4 backdrop-blur-sm">
					<div className="suite-modal-shell-max w-full max-w-4xl overflow-auto rounded-lg border border-green-500/30 bg-[var(--color-surface)] backdrop-blur-xl">
