          ...
          {compareResult.agent_pre_review ? (
            <Stack gap={1}>
              <Text
                size="xs"
                color={
                  compareResult.agent_pre_review.available ? "muted" : "warning"
                }
              >
              ...
              <Text size="xs" color="muted">
                Attempted{" "}
                {compareResult.agent_pre_review.attempted ? "yes" : "no"}
            ...
            {compareResult.shadow_advisor ? (
              <Stack gap={1}>
                ...
                {compareResult.shadow_advisor.auth ? (
                  <Text size="xs" color="muted">
                    Advisor auth: mode {compareResult.shadow_advisor.auth.mode}{" "}
                    | token {compareResult.shadow_advisor.auth.token_source} |
                    refresh{" "}
                            ...
                            return (
                              ...
                              >
                                ...
                                <span>
                                  ...
                                  typeof candidate.score_components
                                    .agent_boost === "number"
