...
const appItems: SectionItem[] = [
  ...
  { id: "ground-grid-generator", label: "Ground Grid Generator", icon: MapPin, path: "/apps/ground-grid-generator" },
  { id: "drawing-list", label: "Drawing List Manager", icon: FileSpreadsheet, path: "/apps/drawing-list" },
