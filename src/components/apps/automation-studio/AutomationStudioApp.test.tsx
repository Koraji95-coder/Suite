...
vi.mock("./useAutomationStudioState", () => ({
	useAutomationStudioState: () => ({
		...
		workflowLinks: [
			{ label: "Review", to: "/app/projects/project-1?view=review" },
			{ label: "Issue Sets", to: "/app/projects/project-1?view=issue-sets" },
			{
				label: "Transmittal",
				to: "/app/apps/transmittal-builder?project=project-1&issueSet=issue-1",
			},
		],
...
vi.mock("@/components/apps/autodraft-studio/AutoDraftComparePanel", () => ({
...
vi.mock("@/components/apps/automation-studio/TerminalAuthoringPanel", () => ({
			...
			<button
				...
				onClick={() =>
					onAutomationSnapshotChange?.({
						...
						warnings: [],
						readyForPlan: true,
						summary: "2 strip writes and 3 route upserts are ready for issue-set apply.",
						queueItems: [
							{
								id: "wire-1",
								source: "autowire",
...
vi.mock("@/components/apps/automation-studio/CadUtilitiesPanel", () => ({
	CadUtilitiesPanel: ({
		onAutomationSnapshotChange,
	}: {
		onAutomationSnapshotChange?: (snapshot: Record<string, unknown>) => void;
...
vi.mock("@/components/apps/automation-studio/AutomationRecipePanel", () => ({
