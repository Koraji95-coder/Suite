              ...
              {state.backendConnected ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ color: palette.textMuted, fontSize: '10px' }}>(checking every 5s)</span>
                  </div>
                  <div style={{ color: palette.textMuted, fontSize: '11px', lineHeight: '1.6' }}>
                    <div style={{ fontWeight: '600', color: palette.text, marginBottom: '6px', fontSize: '12px' }}>
                      How to start the backend:
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                      <div>
                        <span style={{ color: palette.text, fontWeight: '500' }}>Option 1</span>
                        <span style={{ color: palette.textMuted }}> -- From the project folder, run:</span>
                        <div
                          onClick={() => {
                        ...
                        >
                          ...
                          <span style={{ fontSize: '10px', color: palette.textMuted }}>click to copy</span>
                        </div>
                      </div>
                      <div>
                        <span style={{ color: palette.text, fontWeight: '500' }}>Option 2</span>
                        <span style={{ color: palette.textMuted }}> -- Double-click </span>
                        <code style={{
                          padding: '1px 5px',
                          borderRadius: '3px',
                          background: hexToRgba(palette.background, 0.8),
                      ...
                      <div style={{ fontSize: '10px', color: palette.textMuted, borderTop: `1px solid ${hexToRgba(palette.primary, 0.08)}`, paddingTop: '6px' }}>
