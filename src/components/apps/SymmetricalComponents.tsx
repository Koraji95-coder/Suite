			...
			<FrameSection title="Theory">
				<div className="space-y-3 text-white/80">
					...
					<ul className="list-disc list-inside space-y-2 pl-4">
						<li>
							<strong className="text-white/90">Positive-sequence (1):</strong>{" "}
							Three phasors equal in magnitude, displaced 120° from each other,
							with same phase sequence as original (abc)
						</li>
						<li>
							<strong className="text-white/90">Negative-sequence (2):</strong>{" "}
							Three phasors equal in magnitude, displaced 120° from each other,
							with opposite phase sequence (acb)
						</li>
						<li>
							<strong className="text-white/90">Zero-sequence (0):</strong>{" "}
			...
			<FrameSection title="Sequence Components for Other Phases">
				...
				<div className="mt-4 bg-gradient-to-br from-orange-500/10 to-amber-500/10 border border-orange-500/30 rounded-lg p-4">
					<p className="text-white/80 text-sm">
						<strong className="text-white/90">Note:</strong> All three phases
						have the same zero-sequence component. The positive and negative
						sequence components rotate according to the operator 'a'.
					</p>
				</div>
			</FrameSection>
